...
.computeMSPE <- function(X, coef, h, t) {
    .Call('forecastSNSTS_computeMSPE', PACKAGE = 'forecastSNSTS', X, coef, h, t)
}
...
.tvARMA <- function(z, x_init, A, B, Sigma) {
    .Call('forecastSNSTS_tvARMA', PACKAGE = 'forecastSNSTS', z, x_init, A, B, Sigma)
}
